...
const MobileScroll = () => {
    ...
    return (<div className="max-width flex mobile-scroll">
        <div className="scroll-full-screen-wrapper">
            {scrollData.map((screen, i) => (
                <div className="scroll-full-screen">
                    <ScreenText screen={screen} i={i} key={i} setCurrentImg={setCurrentImg} />
                </div>
            ))}
        </div>
            ...
            <div className="mobile-mockup">
                <div className="mobile-mockup-screen flex absolute-center">
                    <img src={scrollData[currentImg].mobile_img}
                        ...
                        alt={scrollData[currentImg].heading} className="mobile-screen-img slide-in-right" />
                </div>
            </div>
        </div>
    </div>);
